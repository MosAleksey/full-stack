...
const NavBar = () => {
    return (
        <Navbar bg="primary" variant="dark">
            <Container>
                <Navbar.Brand href="#home" style={{fontWeight:'600'}}>ADS Online<br/><span style={{fontSize: '14px', fontWeight:'400'}}>Система управления сервисного отдела</span></Navbar.Brand>
